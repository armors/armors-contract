...
contract('ArmorsToken', function ([_, owner, recipient, anotherAccount]) {
  const ZERO_ADDRESS = '0x0000000000000000000000000000000000000000';
  const TOTALSUPPLY = new BigNumber(21000000000 * 10 ** 18);

  beforeEach(async function () {
    this.token = await ArmorsToken.new();
    this.token.transfer(owner, 100);
  });
